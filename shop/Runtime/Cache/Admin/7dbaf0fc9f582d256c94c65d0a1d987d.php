			...
			<div class="panel-body">
				<div class="builder formbuilder-box">
					...
					<div class="builder-container">
						<div class="row">
							<div class="col-xs-12">
								<form action="/admin/Scroll/add.html" method="POST" class="form-horizontal form form-builder" enctype="multipart/form-data">
									<div class="form-type-list">

										<div class="form-group item_title ">
											<label class="left control-label">星座名称：</label>
											<div class="right">
												<input type="text" class="form-control input" name="title" value="" placeholder="星座名称">
											</div>
										</div>
										<div class="form-group item_title">
										...
										<div class="form-group item_title ">
											...
											<div class="right">
												<input type="text" class="form-control input" name="value_region" value="" placeholder="请用'-'号隔开">
											</div>
										</div>
										<div class="form-group item_title ">
											<label class="left control-label">预约时间：</label>
											<div class="right">
												<input type="text" class="form-control input" name="yuyue_time_region" value="" placeholder="请用'-'号隔开">
											</div>
										</div>
										<div class="form-group item_title ">
											<label class="left control-label">抢购时间：</label>
											<div class="right">
												<input type="text" class="form-control input" name="time_region" value="" placeholder="请用'-'号隔开">
											</div>
										</div>
										...
										<div class="form-group item_title ">
											...
											<div class="right">
												<input type="number" class="form-control input text" name="book_consume" value="" placeholder="预约消耗购物券">
											</div>
										</div>
										...
										<div class="form-group item_title ">
											...
											<div class="right">
												<input type="number" class="form-control input text" name="rush_consume" value="" placeholder="收藏消耗购物券">
											</div>
										</div>
										...
										<div class="form-group item_title ">
											...
											<div class="right">
												<input type="number" class="form-control input" name="profit_day" value="" placeholder="收益时间(天)">
											</div>
										</div>
										...
										<div class="form-group item_title ">
											...
											<div class="right">
												<input type="number" class="form-control input text" name="profit_value" value="" placeholder="收益百分比（%）">
											</div>
										</div>
										...
										<div class="form-group item_title ">
											...
											<div class="right">
												<input type="number" class="form-control input text" name="feed_consume" value="" placeholder="收藏消耗购物券">
											</div>
										</div>
										<div class="form-group item_title ">
											<label class="left control-label">最多使用数量：</label>
											<div class="right">
												<input type="text" class="form-control input text" name="max_size" value="" placeholder="最多使用数量">
											</div>
										</div>
