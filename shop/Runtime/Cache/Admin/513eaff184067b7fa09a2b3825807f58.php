                        ...
                        <div class="tab-content" >
                            ...
                            <div id="tab1" class="tab-pane active" >
                                <div class="col-xs-12">
                                        ...
                                        <form action="/admin/User/AddFruits/id/8806.html" method="post" class="form-horizontal form form-builder form1">
                                        <div class="form-type-list">
                                           ...
                                           <div class="form-group item_title ">
                                            ...
                                            <div class="form-group item_title ">
                                             ...
                                             <div class="form-group item_title ">
                                                <label class="left control-label">购物券：</label>
                                                <div class="right">
                                                   <?php echo ($info['total_lingshi']+0); ?>
                                                </div>
                                            </div>

                                            <div class="form-group item_title ">
                                                <label class="left control-label">星座收益：</label>
                                                <div class="right">
                                                    <?php echo ($info['total_active']+0); ?>
                                                </div>
                                            </div>
											<div class="form-group item_title ">
											    <label class="left control-label">推广收益：</label>
											    <div class="right">
											        <?php echo ($info['total_tuiguang']+0); ?>
											    </div>
											</div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">GEO：</label>
                                                <div class="right">
                                                    <?php echo ($info['geo']+0); ?>
                                                </div>
                                            </div>
                                            <div class="form-group item_pid ">
                                                ...
                                                <div class="right">
                                                    <select name="opetype" class="form-control cui-select select">
                                                        ...
                                                        <option value="1" selected="">购物券</option>
                                                        <option value="2">星座收益</option>
														<option value="3">推广收益</option>
                            ...
                            <!-- 卡片2 -->
                             <div id="tab2" class="tab-pane" >
                                    <div class="col-xs-12">
                                        ...
                                        <div style="height:20px;" ></div>
                                        <form action="/admin/User/AddFruits/id/8806.html" method="post" class="form-horizontal form form-builder form2">
                                        <div class="form-type-list">
                                            <div class="form-group hidden item_id ">
                                                <label class="left control-label">ID：</label>
                                                <div class="right">
