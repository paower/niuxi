            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/admin/User/user_level_edit/id/1.html" method="post" class="form-horizontal form form-builder" enctype="multipart/form-data">
                                        <div class="form-type-list">

                                            <div class="form-group item_title ">
                                                <label class="left control-label">等级名称：</label>
                                                <div style="width:200px" class="input-group">
                                                   <input type="text" class="form-control" name="title" value="<?php echo ($user_level['title']); ?>" placeholder="等级名称" >
                                                </div>
                                            </div>
                                            <!-- <div class="form-group item_title ">
                                                <label class="left control-label">是否实名：</label>
                                                <div class="right">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="is_real_name" id="" value="1" <?php echo ($user_level['is_real_name']==1?'checked':''); ?>> 是
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="is_real_name" id="" <?php echo ($user_level['is_real_name']==0?'checked':''); ?> value="0"> 否
                                                    </label>
                                                </div>
                                            </div> -->
                                            <div class="form-group item_title ">
                                                <label class="left control-label">升级所需直推有效会员人数：</label>
                                                <div style="width:200px" class="input-group">
                                                    <input type="number" class="form-control" name="push_num" value="<?php echo ($user_level['push_num']); ?>" placeholder="升级所需直推有效会员人数" >
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">升级所需团队人数：</label>
                                                <div style="width:200px" class="input-group">
                                                    <input type="number" class="form-control" name="team_num" value="<?php echo ($user_level['team_num']); ?>" placeholder="升级所需团队人数" >
                                                </div>
                                            </div>
                                           <div class="form-group item_title ">
                                                <label class="left control-label">团队收益(%)</label>
                                                <div style="width:200px" class="input-group">
                                                    <input type="number" class="form-control" name="scroll_num" value="<?php echo ($user_level['scroll_num']); ?>" placeholder="团队收益" >
                                                </div>
                                            </div>
                                            </div> 
                                            <!-- <div class="form-group item_title ">
                                                <label class="left control-label">升级所需收益：</label>
                                                <div style="width:200px" class="input-group">
                                                    <input type="number" class="form-control" name="active_num" value="<?php echo ($user_level['active_num']); ?>" placeholder="升级所需活收益：" >
                                                </div>
                                            </div> -->

                                            <!-- <div class="form-group item_title ">
                                                <label class="left control-label">升级所需积分：</label>
                                                <div style="width:200px" class="input-group">
                                                    <input type="number" name="active_jf" class="form-control" placeholder="升级所需积分：" value="<?php echo ($user_level['active_jf']); ?>">
                                                </div>
                                            </div> -->
                                           <!--  <div class="form-group item_title ">
                                            ...
                                            <!-- <div class="form-group item_title ">
                                                <label class="left control-label">赠送星座：</label>
                                                <div style="width:200px" class="input-group">
                                                    <select class="form-control" name="scroll_id">
                                                        <option value="0">无赠送星座</option>
                                                        <?php if(is_array($scroll)): $i = 0; $__LIST__ = $scroll;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php echo ($user_level['scroll_id']==$vo['id']?'selected':''); ?>><?php echo ($vo['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">赠送星座数量：</label>
                                                <div style="width:200px" class="input-group">
                                                    <input class="form-control" name="scroll_num" type="number" value="<?php echo ($user_level['scroll_num']); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group item_title ">
                                                <label class="left control-label">获取手续费：</label>
                                                <div style="width:200px" class="input-group">
                                                    <input type="number" name="service_charge" class="form-control" placeholder="获取手续费" value="<?php echo ($user_level['service_charge']); ?>">
                                            ...
                                            <div class="form-group item_title ">
                                                ...
                                                <img src="<?php echo ($user_level['img']); ?>" width="100px" height="100px" style="margin-top:10px;">
                                            </div> -->
                                            <input type="hidden" name="id" value="<?php echo ($user_level['id']); ?>">
                                            <input type="hidden" name="last_img" value="<?php echo ($user_level['img']); ?>" type="hidden">
             
                                        <div class="form-group"></div>
                                        <div class="form-group bottom_button_list">
                                            <button class="btn btn-primary" type="submit" target-form="form-builder">确定</button>
