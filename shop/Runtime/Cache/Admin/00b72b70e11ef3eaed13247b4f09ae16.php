                                ...
                                <!-- 工具栏按钮 -->
                                    <!-- <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                            <a title="新增" class="btn btn-primary-outline btn-pill" href="<?php echo U('user/user_level_add');?>">新增</a>&nbsp;
                                        </div>
                                    </div> -->
                                              ...
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td>
                                                                <?php echo ($data['push_num']); ?>人 
                                                            </td>
                                                            <td>
                                                                <?php echo ($data['team_num']+0); ?>人 
                                                            </td>
                                                            <td>
                                                                <?php echo ($data['scroll_num']); ?>%
                                                            </td>
                                                            <!-- <td>
                                                                <?php echo ($data['active_num']); ?>
                                                            </td>
                                                            <td>
                                                                <?php echo ($data['active_jf']); ?>
                                                            </td>
                                                            <td>
                                                                <?php if(($data['is_real_name']) == "1"): ?><i class="fa fa-check text-success"></i>
                                                                <?php else: ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a name="edit" title="编辑" class="label label-primary-outline label-pill" href="<?php echo U('User/user_level_edit',array('id'=>$data['id']));?>">编辑</a>

                                                                <!-- <a name="forbid" title="删除" class="label label-danger-outline label-pill ajax-get confirm" href="<?php echo U('User/user_level_del',array('ids'=>$data['id']));?>">删除</a> -->
