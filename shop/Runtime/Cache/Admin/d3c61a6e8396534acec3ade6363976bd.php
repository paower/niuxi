                                              ...
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <!-- <td><?php echo ($data['alipay_number']); ?></td> -->
                                                            <td>
                                                                <a href="<?php echo ($data['pic1']); ?>" target="_blank"><img src="<?php echo ($data['pic1']); ?>" width="100px" height="50px"/></a>
                                                                
                                                            </td>
                                                            
                                                            <td>
                                                                <a href="<?php echo ($data['pic2']); ?>" target="_blank"><img src="<?php echo ($data['pic2']); ?>" width="100px" height="50px"/></a>

                                                            </td>
                                                            <!-- <td> -->
                                                                <!-- <a href="<?php echo ($data['pic3']); ?>" target="_blank"><img src="<?php echo ($data['pic3']); ?>" width="100px" height="50px"/></a> -->

                                                            <!-- </td> -->
                                                            <td>
                                                               <?php if($data['is_verify'] == 0): ?>未审核
                                                                <?php elseif($data['is_verify'] == 1): ?>
                                                                    审核通过
                                                                <?php else: ?>
                                                                    审核不通过<?php endif; ?>
                                                            </td>
                                                            <td>
                                                                <?php if($data['is_verify'] == 0): ?><a name="forbid" title="通过" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo U('UserVerify/setYesVerify',array('id'=>$data['id']));?>">通过</a>
                                                                    <a name="forbid" title="不通过" class="label label-danger-outline label-pill ajax-get confirm" href="<?php echo U('UserVerify/setNoVerify',array('id'=>$data['id']));?>">不通过</a><?php endif; ?>
