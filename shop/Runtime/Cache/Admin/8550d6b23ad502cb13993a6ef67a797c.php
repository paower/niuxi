										...
										<table class="table table-bordered table-striped table-hover">
											...
											<tbody>
												<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
														...
														<td><img height="60px" width="40px" src="<?php echo (get_cover_url($data["scroll_image"])); ?>" /></td>
														<!-- 财富 -->
														<td style="white-space: nowrap;">
															<?php echo ($data['value_region']); ?>
														</td>
														<td><?php echo ($data['yuyue_start_time']); ?> - <?php echo ($data['yuyue_end_time']); ?></td>
														<td><?php echo ($data['start_time']); ?> - <?php echo ($data['end_time']); ?></td>
														<td><?php echo ($data['book_consume']); ?></td>

														<td>
															<?php echo ($data['rush_consume']); ?>
														</td>
														<td>
															<?php echo ($data['profit_day']); ?>天/<?php echo ($data['profit_value']*100); ?>%
														</td>
														<td>
														...
														<td>
															...
															<a name="edit" title="编辑" class="label label-primary-outline label-pill" href="<?php echo U('Scroll/edit',array('id'=>$data['id']));?>">编辑</a>

															<?php if(($data['status']) == "1"): ?><a name="forbid" title="锁定" class="label label-warning-outline label-pill ajax-get confirm" href="<?php echo U('Scroll/setStatus',array('status'=>forbid,'ids'=>$data['id']));?>">锁定</a>
																<?php else: ?>
																<a name="forbid" title="解锁" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo U('Scroll/setStatus',array('status'=>resume,'ids'=>$data['id']));?>">解锁</a><?php endif; ?>
															<a name="forbid" title="删除" class="label label-danger-outline label-pill ajax-get confirm" href="<?php echo U('Scroll/del',array('ids'=>$data['id']));?>">删除</a>
