            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/admin/User/edit/id/8806.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <!-- <div class="form-group item_title "> -->
                                                <!-- <label class="left control-label">禁止会员：</label> -->
                                               ...
                                               <!-- <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;"> -->
                                                ...
                                                <!-- <?php if(in_array(1, $quanxian)) echo "checked" ?> value="1"> -->
                                               ...
                                               <!-- <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;"> -->
                                                <!-- <input type="checkbox" name="quanxian[]"   -->
                                                <!-- <?php if(in_array(2, $quanxian)) echo "checked" ?> value="2"> -->
                                                <!-- <span class="cui-control-indicator"></span> -->
                                                <!-- <span>转出</span> -->
                                               <!-- </label> -->
                                               ...
                                               <!-- <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;"> -->
                                                <!-- <input type="checkbox" name="quanxian[]"   -->
                                                <!-- <?php if(in_array(3, $quanxian)) echo "checked" ?> value="3"> -->
                                                <!-- <span class="cui-control-indicator"></span> -->
                                                <!-- <span>买入</span> -->
                                               <!-- </label> -->
                                               ...
                                               <!-- <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;"> -->
                                                <!-- <input type="checkbox" name="quanxian[]"   -->
                                                <!-- <?php if(in_array(4, $quanxian)) echo "checked" ?> value="4"> -->
                                                <!-- <span class="cui-control-indicator"></span> -->
                                                <!-- <span>卖出</span> -->
                                               <!-- </label> -->
