                                        ...
                                        <form class="form" method="get" action="">
                                            <div class="form-group right">
                                              ...
                                              <div class="sum">
                                                ...
                                                <div>积分总数:<?php echo ($jifen_sum); ?></div> -->
                                              </div>
                                            </div>
                                        </form>
                                    </div>
                                                    ...
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if(!($_SESSION["user_auth"]["uid"]<>1 && $data['yinbi']==1)){ ?>
                                                        <tr>
                                                            ...
                                                            <td style="white-space: nowrap;" >
                                                               ...
                                                               购物券：<span style="color:#dc3300" ><?php echo ($data['total_lingshi']+0); ?></span>
                                                               <br />
                                                               星座收益：<span style="color:#dc3300" ><?php echo ($data['total_active']+0); ?></span>
															    <br />
															   推广收益：<span style="color:#dc3300" ><?php echo ($data['total_tuiguang']+0); ?></span>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <?php echo M('user')->where( array('pid'=>$data['userid'],'is_real_name'=>array('eq',1)))->count(1); ?>人
