                                ...
                                <!-- 工具栏按钮 -->
                                    <div class="col-xs-12 col-sm-8 button-list clearfix">
                                        <div class="form-group">
                                            <a title="新增" class="btn btn-primary-outline btn-pill" href="<?php echo U('Banner/add');?>">新增</a>&nbsp;
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel panel-default table-responsive">
                                            ...
                                            <tbody>
                                                    ...
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td><img height="40px" width="80px" src="<?php echo (get_cover_url($data["picture"])); ?>" /></td>
                                                            ...
                                                            <td>
                                                                <a name="edit" title="编辑" class="label label-primary-outline label-pill" href="<?php echo U('Banner/edit',array('id'=>$data['id']));?>">编辑</a>

                                                                <?php if(($data['status']) == "1"): ?><a name="forbid" title="禁用" class="label label-warning-outline label-pill ajax-get confirm" href="<?php echo U('Banner/setStatus',array('status'=>forbid,'ids'=>$data['id'],'model'=>'Banner'));?>">禁用</a>
                                                              
                                                                <?php else: ?>
                                                                <a name="forbid" title="启用" class="label label-success-outline label-pill ajax-get confirm" href="<?php echo U('Banner/setStatus',array('status'=>resume,'ids'=>$data['id'],'model'=>'Banner'));?>">启用</a><?php endif; ?>

                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm" model="Banner" href="<?php echo U('Banner/setStatus',array('status'=>delete,'ids'=>$data['id'],'model'=>'Banner'));?>">删除</a>
