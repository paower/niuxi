            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                        <div class="row" >
                            <div class="col-xs-12" >
                        转让<hr style="margin-top: 0px;width: 100%">
                        <form action="<?php echo U('Config/groupSave2');?>" method="post" class="form-horizontal form form-builder">
                                <div class="form-type-list">
                                   ...
                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">星座最小转让：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="zhuanrang_min" class="form-control" value="<?php echo ($jifen); ?>" >
                                         
                                        </div>
                                    </div>
                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">星座最大转让：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="zhuanrang_max" class="form-control" value="<?php echo ($regjifen); ?>" >
                                         
                                        </div>
                                    </div>
                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">推广最小转让：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="tzhuanrang_min" class="form-control" value="<?php echo ($jifens); ?>" >
                                         
                                        </div>
                                    </div>
                                   <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">推广最大转让：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="tzhuanrang_max" class="form-control" value="<?php echo ($regjifens); ?>" >
                                         
                                        </div>
                                    </div>
                                    <div class="form-group item_config[WEB_SITE_TITLE] ">
                                        <label class="left control-label">激活所需购物券：</label>
                                        <div style="width:200px" class="input-group">
                                            <input type="number" name="needjifen" class="form-control" value="<?php echo ($needjifen); ?>" >
