            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/admin/News/edit/id/118.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="right">
                                                    <select name="type">
                                                        <option value="1" <?php echo ($info['type'] == 1?'selected':''); ?>>公告</option>
                                                        <option value="2" <?php echo ($info['type'] == 2?'selected':''); ?>>帮助</option>
                                                    </selec>
                                                </div>
                                            </div>
                                            <div class="form-group ">
