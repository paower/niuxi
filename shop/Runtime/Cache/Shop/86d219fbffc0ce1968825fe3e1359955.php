...
<li>
    <input id="Radio1" name="type" checked="checked" value="1" type="radio" onclick="test(this)" /><span style="color: red">个人认证</span>
        ...
        <?php if($uinfo['vip_grade'] > 3): ?><li>
                <input id="Radio2" name="type" type="radio"  value="2" onclick="test(this)" /><span style="color: red">商家认证</span>
            </li><?php endif; ?>
    </ul>
...
<div class="upload">
  ...
  <input type="checkbox" name="vehicle" class="vehicle" value="Car" checked="checked" style="vertical-align: middle;">同意
  <a  onclick="look()">
  <i style="color: #f00">《入驻商城协议》</i>
  </a>
  </p>
 <br/><br/>
<p id='xieyi'></p>
