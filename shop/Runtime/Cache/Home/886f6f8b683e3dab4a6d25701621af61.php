...
<html lang="zh-CN">
	...
	<body class="bg96">
		<div class="header">
			...
			<div class="header_c">
				<?php if($type == 1): ?><h2>添加支付宝</h2>
				<?php elseif($type == 2): ?>
					<h2>添加银行卡</h2>
				<?php elseif($type == 3): ?>
					<h2>添加微信</h2><?php endif; ?>
			</div>
			<div class="header_r"></div>
		</div>
		
		<?php if($type == 1): ?><div class="big_width100">
				<div class="tips">*请绑定本人的支付宝!</div>
				<form id='myupload' action="<?php echo U('Growth/Addbank');?>" method='post' enctype='multipart/form-data'>
					<div class="add_bank_add_gr">
						<input name="type" value="1" type="hidden" />
						<div class="fill_sty add_gr_b10">
							<p>姓名</p>
							<input type="text" name="alipay_name" placeholder="姓名" autocomplete="off" id="crkxm">
						</div>

						<!--支付宝号-->
						<div class="fill_sty add_gr_b10">
							<p>支付宝号</p>
							<input type="text" name="alipay_number" placeholder="支付宝号" autocomplete="off" id="yhk">
						</div>
		...
		<?php elseif($type == 2): ?>
			<div class="fish-main">
				<form id='myupload2' action="<?php echo U('Growth/Addbank');?>" method='post' enctype='multipart/form-data'>
			        <ul class="bus-list">
			            ...
			            <li class="clearfix">
			                ...
			                <div class="inp--field col s9">
			                    <select class="initialized" name="bank_name">
									<?php if(is_array($bakinfo)): $i = 0; $__LIST__ = $bakinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["q_id"]); ?>"><?php echo ($vo["banq_genre"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			                    </select>
			                </div>
			            </li>
			            <li class="clearfix">
			                <div class="col-3">银行卡姓名</div>
			                <div class="col-9"><input type="text" placeholder="请输入银行卡姓名" name="alipay_name"></div>
			            </li>
			            <li class="clearfix">
			                <div class="col-3">银行卡账号</div>
			                <div class="col-9"><input type="text" placeholder="请输入银行卡账号" name="alipay_number"></div>
			            </li>
			            <li class="clearfix">
			                <div class="col-3">开户支行</div>
			                <div class="col-9"><input type="text" placeholder="请输入开户支行" name="bank_name2"></div>
			            </li>
			        </ul>
			    </form>
			    <div class="buttonGeoup">
		...
		<?php elseif($type == 3): ?>
			<div class="big_width100">
				...
				<form id='myupload3' action="<?php echo U('Growth/Addbank');?>" method='post' enctype='multipart/form-data'>
					<div class="add_bank_add_gr">
						<input name="type" value="3" type="hidden" />
						<div class="fill_sty add_gr_b10">
							<p>昵称</p>
							<input type="text" name="alipay_name" placeholder="昵称" autocomplete="off" id="crkxm">
						</div>
			
						<!--支付宝号-->
						<div class="fill_sty add_gr_b10">
							<p>微信号</p>
							<input type="text" name="alipay_number" placeholder="微信号" autocomplete="off" id="yhk">
						</div>
						<div class="acco_con_upa">
							<h3>二维码</h3>
							<div class="shangcjt">
