...
class ConfigController extends AdminController
{
 ...
 public function group1($group = 4)
    ...
    public function group2($group = 1)
    {
        ...
        $jifen= D('config')->where("name='zhuanrang_min'")->getField("value");
        $regjifen= D('config')->where("name='zhuanrang_max'")->getField("value");
 ...
 public function fenx_Save()
   ...
   /**
    ...
    public function groupSave1()
    {
     ...
     $arr=array(1=>"积分",2=>"比特币",3=>"莱特币",4=>"以太坊",5=>"狗狗币");
